...
import '../screen/home/templates/blazer.dart';
import '../screen/home/templates/lehenga.dart';
import '../screen/home/templates/mask.dart';
import '../screen/home/templates/pent.dart';
import '../screen/home/templates/shirt.dart';
import '../screen/home/templates/widgets/custom_text.dart';
import '../screen/home/templates/widgets/im.dart';
...
class _HomeState extends State<Home> {
  ...
  _openCameraAndSaveImage(BuildContext context) async {
  ...
  _openGalleryAndSaveImage(BuildContext context) async {
    final ImagePicker picker = ImagePicker();
                    ...
                    Row(
                      ...
                      children: [
                        GestureDetector(
                          onTap: () async {
                            selectedImagePath =
                                await _openGalleryAndSaveImage(context);
                            print('Image_Path:-');
                        ...
                        GestureDetector(
                          onTap: () async {
                            selectedImagePath =
                                await _openCameraAndSaveImage(context);
                            print('Image_Path:-');
                            print(selectedImagePath);
